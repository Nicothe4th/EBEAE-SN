...
ResultsYh=zeros(length(sSNR),7,Rep);
ResultsVh=zeros(length(sSNR),2,Rep);
ResultsAh=zeros(length(sSNR),7,Rep);
ResultsPh=zeros(length(sSNR),7,Rep);
ResultsTh=zeros(length(sSNR),7,Rep);
ResultsPh2=zeros(length(sSNR),7,Rep);
...
for index=1:length(sSNR)
    ...
    for j=1:Rep 
       ...
       Tmx=toc;
       ResultsYh(index,7,j)=norm(Zh7-Z,'fro')/norm(Z,'fro');
       ResultsAh(index,7,j)=errorabundances(A0,A7);
       ResultsPh(index,7,j)=errorendmembers(P0,P7);
       ResultsPh2(index,7,j)=errorSAM(P0,P7);
       ResultsTh(index,7,j)=Tmx;
...
disp('SNR/Density   EBEAE-SN       EBEAE         PISINMF      HU-JSTV    NMF-QMV    gtvMBO         MaxVolDual');
disp('%%%%%%%%%%%%%%%');
disp('Error in Output Estimation (%)');
disp([num2str(int8(sSNR')) ...
    AAnd num2str(mean(ResultsYh(:,1,:),3),NP) PM num2str(std(ResultsYh(:,1,:),[],3),NP) ...
    ...
    AAnd num2str(mean(ResultsYh(:,6,:),3),NP) PM num2str(std(ResultsYh(:,6,:),[],3),NP) ...
    AAnd num2str(mean(ResultsYh(:,7,:),3),NP) PM num2str(std(ResultsYh(:,7,:),[],3),NP) ...
    EEnd]);
...
disp([num2str(int8(sSNR')) ...
    ...
    AAnd num2str(mean(ResultsAh(:,6,:),3),NP) PM num2str(std(ResultsAh(:,6,:),[],3),NP) ...
    AAnd num2str(mean(ResultsAh(:,7,:),3),NP) PM num2str(std(ResultsAh(:,7,:),[],3),NP)...
    EEnd]);

disp('%%%%%%%%%%%%%%%');
disp('Error in End-member Estimation');
disp([num2str(int8(sSNR')) ...
    AAnd num2str(mean(ResultsPh(:,1,:),3),NP) PM  num2str(std(ResultsPh(:,1,:),[],3),NP) ...
    ...
    AAnd num2str(mean(ResultsPh(:,6,:),3),NP) PM num2str(std(ResultsPh(:,6,:),[],3),NP) ...
    AAnd num2str(mean(ResultsPh(:,7,:),3),NP) PM num2str(std(ResultsPh(:,7,:),[],3),NP) ...
    EEnd]);

disp('%%%%%%%%%%%%%%%');
disp('Error in End-member Estimation (SAM)');
disp([num2str(int8(sSNR')) ...
    AAnd num2str(mean(ResultsPh2(:,1,:),3),NP) PM  num2str(std(ResultsPh2(:,1,:),[],3),NP) ...
    ...
    AAnd num2str(mean(ResultsPh2(:,6,:),3),NP) PM num2str(std(ResultsPh2(:,6,:),[],3),NP) ...
    AAnd num2str(mean(ResultsPh2(:,7,:),3),NP) PM num2str(std(ResultsPh2(:,7,:),[],3),NP) ...
    EEnd]);

disp('%%%%%%%%%%%%%%%');
disp('Computation Time');
disp([num2str(int8(sSNR')) ...
    AAnd num2str(mean(ResultsTh(:,1,:),3),NP) PM num2str(std(ResultsTh(:,1,:),[],3),NP) ...
    ...
    AAnd num2str(mean(ResultsTh(:,6,:),3),NP) PM num2str(std(ResultsTh(:,6,:),[],3),NP) ...
    AAnd num2str(mean(ResultsTh(:,7,:),3),NP) PM num2str(std(ResultsTh(:,7,:),[],3),NP) ...
    EEnd]);
...
comparisonNames = {' vs_EBEAE', '     vs_PISINMF', '     vs_JSTV', '     vs_NMF-QMV', '   vs_gtvMBO', 'vs_MaxVolDual'};
