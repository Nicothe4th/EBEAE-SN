function [Y,P,A,V,D]=SphericGaussian_Sparse_Synth(SNR,density,ModelType)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% [Y,P,A,V,D]=SphericGaussian_Sparse_Synth(SNR,PSNR,ModelType)
%
% Synthetic Chromofores dataset with linear or non-linear mixing models:
%
...
prob=randn(Npixels, Npixels)*0.2+0.1;
prob(prob>1)=1;
...
load('DatasetSynth/AbundancesSphericGaussian.mat')
a1=squeeze(A(:,:,1));
a2=squeeze(A(:,:,2));
a3=squeeze(A(:,:,3));
a4=squeeze(A(:,:,4));
